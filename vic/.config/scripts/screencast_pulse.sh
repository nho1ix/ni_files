...
ffmpeg -y -r 60 \
-f x11grab -s $(xdpyinfo | rg dimensions | awk '{print $2;}') \
-i :0.0 \
-f pulse -i alsa_input.usb-Blue_Microphones_Yeti_Stereo_Microphone_LT_190807130008F3990478_111000-00.analog-stereo \
-f pulse -i alsa_output.usb-Blue_Microphones_Yeti_Stereo_Microphone_LT_190807130008F3990478_111000-00.analog-stereo.monitor -ac 2 -filter_complex -async 1 amerge $filename
